class level2 {
  ...
  player player1;
  player player2;
  // Arraylist< mushrums> Mushrums;
  level2() {

    // Arraylist< mushrums> Mushrums= Mushrums = new ArrayList<mushrums>();  
  ...
  void draw() {
    ...
    for (centipede centipedeDraw : Centipedes) {
      ...
      for (int i = 0; i < playerOneLazer.size(); i++) {
        ...
        if (centipedeDraw.Die(lazer.location.x, lazer.location.y)) {
  ...
  void mushrooms()
  {
    ...
    image(mushroom, 1330, height-20, 20, 20);
    image(mushroom, 1290, height-60, 20, 20);
    image(mushroom, 330, height-30, 20, 20);
    image(mushroom, 290, height-55, 20, 20);
    image(mushroom, 1130, height-30, 20, 20);
    image(mushroom, 1390, height-55, 20, 20);
    ...
    image(mushroom, 1330, height-300, 20, 20);
    image(mushroom, 1290, height-200, 20, 20);
    image(mushroom, 980, height-320, 20, 20);
    image(mushroom, 1190, height-280, 20, 20);
  }
}